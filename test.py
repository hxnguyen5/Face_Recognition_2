...
while True:
        ...
        for (x, y, w, h) in faces:
                ...
                if label == config.BILLY_LABEL and confidence < 2600:
                        print 'Recognized face! Hello Billy!'
                        cv2.rectangle(frame, (x, y), (x+w, y+h), (0, 255, 0), 2)
#                        light.set_color(0, 255, 0)
#                        d.move(0, 0)
#                        d.write("Hello BILL".format(label))
                elif label == config.MOMMY_LABEL and confidence < 2600:
                        print 'Recognized face! Hello Mommy!'
                        cv2.rectangle(frame, (x, y), (x+w, y+h), (0, 255, 0), 2)
#                        light.set_color(0, 255, 0)
#                        d.move(0, 0)
#                        d.write("Hello Antho".format(label))
                elif label == config.CODY_LABEL and confidence < 2600:
                        print 'Recognized face! Hello Cody!'
                        cv2.rectangle(frame, (x, y), (x+w, y+h), (0, 255, 0), 2)
#                        light.set_color(0, 255, 0)
#                        d.move(0, 0)
#                        d.write("Hello Nico".format(label))
                elif label == config.CASEY_LABEL and confidence < 2600:
                        print 'Recognized face! Hello Casey!'
                        cv2.rectangle(frame, (x, y), (x+w, y+h), (0, 255, 0), 2)
#                        light.set_color(0, 255, 0)
#                        d.move(0, 0)
